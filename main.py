...
def main(t=0):
    ...
    print()
    print("  \u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557")
    print("  \u2551          NEWZYX V2 \u2014 DAILY PIPELINE          \u2551")
    ...
    if not ep:
        ...
        run_step(5, lambda: episode.create_script(script_path, ep, t=t))
...
def countdown(target_time):
    while True:
        ...
        if remaining <= 0:
            sys.stdout.write("\r  \u23f3 Next run in: 00:00:00   \n")
            sys.stdout.flush()
            break
        h = int(remaining // 3600)
        m = int((remaining % 3600) // 60)
        s = int(remaining % 60)
        sys.stdout.write(f"\r  \u23f3 Next run in: {h:02d}:{m:02d}:{s:02d}   ")
        sys.stdout.flush()
        time.sleep(1)


def loop_to_run_daily_at_4am():
    while True:
        now = datetime.now()
        target_time = now.replace(hour=5, minute=2, second=0, microsecond=0)
        if now >= target_time:
            target_time += timedelta(days=1)

        print()
        print("  \u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557")
        print("  \u2551          NEWZYX V2 \u2014 DAILY SCHEDULER         \u2551")
        print(f"  \u2551  Next run: {target_time.strftime('%Y-%m-%d %H:%M:%S')}                  \u2551")
        print("  \u255a\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255d")
        print()
